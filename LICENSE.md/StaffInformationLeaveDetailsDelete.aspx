    ...
    <form id="Form1" runat="server">
        ...
        <div id="LeaveDetails">
            ...
            <div id="LeaveDetailsContentDiv">
        		<asp:Table runat="server" ID="LeaveDetailsContentTable">
                    ...
                    <asp:TableRow>
                        <asp:TableCell ColumnSpan="3"><asp:CheckBox ID="CheckBox" runat="server"></asp:CheckBox>Value From Database</asp:TableCell>
        ...
        <!-- ********** Start of Button ******************* -->
                <div id="Buttons" style="position:absolute;top:1200px;width:100%;outline:none;">
                    <asp:Button value="Delete Leave" runat="server" Text="Delete Leave" ID="DeleteLeave" name="DeleteLeave"  class="BlueButton" ></asp:Button>
                </div>
        <!-- *********** End of Button ******************* --> 
        </form>
