<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffSalaryMonitoringSystem.aspx.cs" Inherits="StaffSalaryMonitoringSystem" %>
...
<head id="Head1" runat="server">
		...
		<title>Staff Salary Monitoring System</title>
        <style type="text/css">
    ...
    <form id="PayrollStaffTransferForm" runat="server">
        ...
        <div id="StaffWorkProfileSystem">
        	<div id="StaffWorkProfileSystemBanner">
                Staff Salary Monitoring System
            </div>
        	<div id="StaffWorkProfileSystemContent">
            	<asp:Table runat="server" ID="StaffWorkProfileSystemContentTable">
                	<asp:TableRow></asp:TableRow>
                     <asp:TableRow>
                        <asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding-left:5px">To Enter Staff New Salary click on the Add button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px">To Edit Staff Salary Profile Select Respective Details and click on the Edit Button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To Delete Staff Salary Profile Select Respective Details and click on the Delete button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To View Staff Salary Profile Select Respective Details and click on the View button.</asp:TableCell>
