<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnquiryRegistrationSystem.aspx.cs" Inherits="EnquiryRegistrationSystem" %>
...
<head id="Head1" runat="server">
		...
		<title>Enquiry Registration System</title>
        <style type="text/css">
    ...
    <form id="PayrollStaffTransferForm" runat="server">
        ...
        <div id="StaffWorkProfileSystem">
        	<div id="StaffWorkProfileSystemBanner">
                Enquiry Registration System
            </div>
        	<div id="StaffWorkProfileSystemContent">
            	<asp:Table runat="server" ID="StaffWorkProfileSystemContentTable">
                	<asp:TableRow></asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding-left:5px">To Enter Enquiry and Registration click on the Add button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px">To Edit Enquiry and Registration Select Respective Details and click on the Edit Button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To Delete Enquiry and Registratione Select Respective Details and click on the Delete button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To View Enquiry and Registration Select Respective Details and click on the View button.</asp:TableCell>
