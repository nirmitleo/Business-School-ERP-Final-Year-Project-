<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationLeaveDetailsView.aspx.cs" Inherits="StaffInformationLeaveDetailsView" %>
...
<head id="Head1" runat="server">
        ...
        <style type="text/css">
            ...
            */
            ...
            table#SomeSectionTable tr#TableHeadingRow td
            {
                width:100%;
                background-color:#688890;
                color:white;
    ...
    <form id="Form1" runat="server">
        		...
        		<asp:Table runat="server"  ID="StaffInformationContentTable">
                    <asp:TableRow>
                     ...
                     <asp:TableRow>
                        ...
                        <asp:TableCell runat="server" ID="StaffCode" CssClass="RedFont"></asp:TableCell>
                        <asp:TableCell>STAFF NAME:</asp:TableCell>
                        <asp:TableCell ColumnSpan="3" runat="server" ID="StaffName" CssClass="RedFont"></asp:TableCell>
                        <asp:TableCell>DATE OF BIRTH:</asp:TableCell>
                        <asp:TableCell runat="server" ID="DOB"  CssClass="RedFont"></asp:TableCell>
                        <asp:TableCell>CONTACT NO:</asp:TableCell>
                        <asp:TableCell runat="server" ID="ContactNo" CssClass="RedFont"></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell runat="server" ID="DateOfJoin" CssClass="RedFont"></asp:TableCell>
                        <asp:TableCell>DESIGNATION:</asp:TableCell>
                        <asp:TableCell ColumnSpan="3" runat="server" ID="Designation" CssClass="RedFont"></asp:TableCell>
                        <asp:TableCell>PF NO:</asp:TableCell>
                        <asp:TableCell runat="server" ID="PfNo" CssClass="RedFont"></asp:TableCell>
                        <asp:TableCell>BLOOD GROUP:</asp:TableCell>
                        <asp:TableCell runat="server" ID="BloodGroup" CssClass="RedFont"></asp:TableCell>
                    </asp:TableRow>
            ...
            <div id="LeaveDetailsContentDiv">
        		<asp:Table runat="server" ID="LeaveDetailsContentTable">
                    <asp:TableRow id="TableHeadingRow">
                        <asp:TableCell ColumnSpan="3">SR NO(Click On Sr No To Edit)</asp:TableCell>
                        <asp:TableCell>From Date</asp:TableCell>
                        <asp:TableCell>To Date</asp:TableCell>
                        <asp:TableCell ColumnSpan="9">Reason of Leave</asp:TableCell>
                        <asp:TableCell>No of Days</asp:TableCell>
                        <asp:TableCell ColumnSpan="4">Leave Category</asp:TableCell>
                    </asp:TableRow>
                 </asp:Table>
            </div>
         </div>
       ...
       <div style="position:absolute;top:1000px;width:100%;outline:none;">
       <!--<asp:Pre>Thanks for viewing the Leave Details!!</asp:Pre>-->
       </div>
