<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationLeaveDetails.aspx.cs" Inherits="StaffInformationLeaveDetails" %>
...
<head id="Head1" runat="server">
    ...
    <form id="Form1" runat="server">
            ...
            <div id="LeaveDetailsContentDiv">
        		<asp:Table runat="server" ID="LeaveDetailsContentTable">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell>Value From Database</asp:TableCell>
                        <asp:TableCell ColumnSpan="9">Value From Database</asp:TableCell>
                        <asp:TableCell>Value From Database</asp:TableCell>
                        <asp:TableCell ColumnSpan="4">Value From Database</asp:TableCell>
                    </asp:TableRow>
                 </asp:Table>
            </div>
         </div>
        ...
        <!-- ************* Start of SomeSection ****************** -->
        
        <div id="SomeSection">
        	<asp:Table runat="server" ID="SomeSectionTable">
            	<asp:TableRow id="Tr1">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell ColumnSpan="2">
                    	<label for="NoOfDaysTakenLeave">No of Days taken Leave</label>
                        <asp:TextBox TextMode="SingleLine" runat="server" ID="NoOfDaysTakenLeave"></asp:TextBox>*
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                	<asp:TableCell ColumnSpan="2">
                        <label for="ReasonOfLeave">Reason Of Leave</label>
                        <textarea id="ReasonOfLeave" rows="4" cols="20"></textarea>*
                    </asp:TableCell>
                    <asp:TableCell>
                    	<label for="LeaveCategory">Leave Category</label>
                        <asp:DropDownList runat="server" ID="LeaveCategory" name="LeaveCategory">
                        	<asp:ListItem selected="True">Select</asp:ListItem>
                            <asp:ListItem value="Casual Leave">Casual Leave</asp:ListItem>
                            <asp:ListItem value="Without Pay">Without Pay</asp:ListItem>
        ...
        <!-- ********** Start of Button ******************* -->
                <div id="Buttons" style="position:absolute;top:1200px;width:100%;outline:none;">
                    <asp:Button value="Confirm Transfer" runat="server" Text="Confirm Transfer" ID="ConfirmTransfer" name="ConfirmTransfer"  class="BlueButton" ></asp:Button>
                </div>
        <!-- *********** End of Button ******************* --> 
        </form>
