<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationBasicSalaryDetail.aspx.cs" Inherits="StaffInformationBasicSalaryDetail" %>
        ...
        <!-- ************* Start of Leave Details ****************** -->
          ...
          <!-- ********** Start of Button ******************* -->
                <div id="Buttons" style="position:absolute;top:1000px;width:100%;outline:none;">
                    <asp:Button value="Add Salary" runat="server" Text="Add Salary" ID="AddSalary" name="AddSalary"  class="BlueButton" ></asp:Button>
                </div>
        <!-- *********** End of Button ******************* --> 
