<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffLeaveMonitoringSystem.aspx.cs" Inherits="StaffLeaveMonitoringSystem" %>
...
<head id="Head1" runat="server">
		...
		<title>Staff Leave Monitoring System</title>
        <style type="text/css">
    ...
    <form id="PayrollStaffTransferForm" runat="server">
        ...
        <div id="StaffWorkProfileSystem">
        	<div id="StaffWorkProfileSystemBanner">
                Staff Leave Monitoring System
            </div>
        	<div id="StaffWorkProfileSystemContent">
            	<asp:Table runat="server" ID="StaffWorkProfileSystemContentTable">
                	<asp:TableRow></asp:TableRow>
                     <asp:TableRow>
                        <asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding-left:5px">To Enter Staff New Leave Profile click on the Add button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px">To Edit Staff Leave Profile Details Select Respective Details and click on the Edit Button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To Delete Staff Leave Profile Details Select Respective Details and click on the Delete button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To View Staff Leave Profile Details Select Respective Details and click on the View button.</asp:TableCell>
