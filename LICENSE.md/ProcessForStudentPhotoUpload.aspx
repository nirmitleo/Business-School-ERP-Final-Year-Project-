<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProcessForStudentPhotoUpload.aspx.cs" Inherits="ProcessForStudentPhotoUpload" %>
    ...
    <title></title>
       ...
       <style type="text/css">
            ...
            *
            ...
            /*--------Styling the Process For Student Photo Upload--------*/
            div#ProcessForStudentPhotoUpload
            {
                display:block;
                position:absolute;
                width:100%;
            ...
            div#ProcessForStudentPhotoUpload div#ProcessForStudentPhotoUploadBanner
            {
                display:block;
                height:30px;
                line-height:30px;
            ...
            div#ProcessForStudentPhotoUpload table,tr,td 
            {
                border:white solid 1px;
                border-collapse:collapse;
                height:60px;
            }
            div#ProcessForStudentPhotoUpload table 
            {
                position:absolute;
                width:100%;
                
            }
            div#ProcessForStudentPhotoUpload .BlueButton
            {
                background:#018788;
                width:75px;
                height:25px;
            ...
            div#ProcessForStudentPhotoUpload .BlueButton:hover
            {
                cursor:pointer;
            }
            
            
            div#ProcessForStudentPhotoUploadContent table tr#TableHeadingRow td
            {
...
<body>
    <form id="ProcessForStudentPhotoUploadForm" runat="server">
    

        <!-- *************Kohinoor Banner****************** -->
    	<div id="KohinoorBanner">
        	<asp:Image runat="server" src="D:\Images\Kohinoor.jpg" alt="KohinoorLogo"></asp:Image>
        ...
        <!-- *************Process For Student Photo Upload****************** -->
        <div id="ProcessForStudentPhotoUpload">
        	<div id="ProcessForStudentPhotoUploadBanner">
                Process For Student Photo Upload
            </div>
        	<div id="ProcessForStudentPhotoUploadContent">
