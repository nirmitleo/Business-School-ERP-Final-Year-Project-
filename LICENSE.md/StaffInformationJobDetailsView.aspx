<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationJobDetailsView.aspx.cs" Inherits="StaffInformationJobDetailsView" %>
...
<head id="Head1" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <div id="JobDetails">
        	<div id="JobDetailsBanner">
                Job Details
            </div>
            <div id="JobDetailsContentDiv">
        		<asp:Table runat="server" ID="JobDetailsContentTable">
       ...
       <Pre>Thanks for viewing the Work Profile Details!!</Pre>
       </div>
