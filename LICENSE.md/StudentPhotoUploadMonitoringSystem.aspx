<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentPhotoUploadMonitoringSystem.aspx.cs" Inherits="StudentPhotoUploadMonitoringSystem" %>
        ...
        <div id="StudentPhotoUploadMonitoringSystem">
            ...
            <div id="StudentPhotoUploadMonitoringSystemContent">
            	<asp:Table runat="server" ID="StudentPhotoUploadMonitoringSystemContentTable">
                    ...
                    <asp:TableRow>
                        <asp:TableCell style="color:#264f9f;font-size:12px;font-family:Segoe UI;padding-left:5px;font-size:11px;">To Search Student Details Select Respective and click on the Search button.</asp:TableCell>
