<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationBasicSalaryDetailDelete.aspx.cs" Inherits="StaffInformationBasicSalaryDetailDelete" %>
        ...
        <!-- ************* Start of Leave Details ****************** -->
          ...
          <!-- ********** Start of Button ******************* -->
                <div id="Buttons" style="position:absolute;top:1000px;width:100%;outline:none;">
                    <asp:Button value="Delete Salary" runat="server" Text="Delete Salary" ID="DeleteSalary" name="DeleteSalary"  class="BlueButton" ></asp:Button>
                </div>
        <!-- *********** End of Button ******************* --> 
