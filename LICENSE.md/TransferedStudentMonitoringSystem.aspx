<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferedStudentMonitoringSystem.aspx.cs" Inherits="TransferedStudentMonitoringSystem" %>
...
<head id="Head1" runat="server">
		...
		<title>Transfered Student Monitoring System</title>
        <style type="text/css">
    ...
    <form id="PayrollStaffTransferForm" runat="server">
        ...
        <div id="StaffWorkProfileSystem">
        	<div id="StaffWorkProfileSystemBanner">
                Transfered Student Monitoring System
            </div>
        	<div id="StaffWorkProfileSystemContent">
            	<asp:Table runat="server" ID="StaffWorkProfileSystemContentTable">
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px">To Edit Enquiry Or Registration Of Transfered Student Select Respective Details and click on the Edit Button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To Delete Enquiry Or Registration Of Transfered Student Select Respective Details and click on the Delete button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To View Enquiry Or Registration Of Transfered Student Select Respective Details and click on the View button.</asp:TableCell>
