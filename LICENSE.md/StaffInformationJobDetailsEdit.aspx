<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationJobDetailsAdds.aspx.cs" Inherits="StaffInformationJobDetailsAdds" %>
...
<head id="Head1" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <!-- ************* Start of Leave Details ****************** -->
         <div>
            <div id="Bottom"  style="position:absolute;top:700px;width:100%;outline:none;">
        		<asp:Table runat="server" ID="TableAdd">
                    <asp:TableRow id="TableRow1">
                    <asp:TableCell>
                        <label for="CourseName">Course Name</label>
                        <asp:DropDownList runat="server" ID="DropDownList1" name="Year">
                        	<asp:ListItem value="Select">Select</asp:ListItem>
                            <asp:ListItem value="Financial Accounting">Financial Accounting</asp:ListItem>
                            <asp:ListItem value="Motor Rewinding">Motor Rewinding</asp:ListItem>
                            <asp:ListItem value="Welding">Welding</asp:ListItem>
                            <asp:ListItem value="Video Shooting">Video Shooting</asp:ListItem>
                        ...
                        <asp:DropDownList runat="server" ID="DropDownList2" name="Year">
                        	<asp:ListItem value="Select">Select</asp:ListItem>
                            <asp:ListItem value="4 to 6">4 to 6</asp:ListItem>
                            <asp:ListItem value="1 to 3">1 to 3</asp:ListItem>
                            <asp:ListItem value="10 to 12">10 to 12</asp:ListItem>
                     ...
                     <asp:TableCell>
                       ...
                       <asp:TableCell>
                         <label for="DutyHrs">Month</label>
                        <asp:DropDownList runat="server" ID="Month" name="Month">
                        	<asp:ListItem value="Select">Select</asp:ListItem>
        ...
        <!-- ************* Start of Leave Details ****************** -->
          ...
          <!-- ********** Start of Button ******************* -->
                <div id="Buttons" style="position:absolute;top:1000px;width:100%;outline:none;">
                    <asp:Button value="Add Job" runat="server" Text="Add Job" ID="AddJob" name="AddJob"  class="BlueButton" ></asp:Button>
                </div>
        <!-- *********** End of Button ******************* --> 
