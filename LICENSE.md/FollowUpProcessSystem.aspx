<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FollowUpProcessSystem.aspx.cs" Inherits="FollowUpProcessSystem" %>
...
<head id="Head1" runat="server">
		...
		<title>Followup Process System</title>
        <style type="text/css">
    ...
    <form id="PayrollStaffTransferForm" runat="server">
        ...
        <div id="StaffWorkProfileSystem">
        	<div id="StaffWorkProfileSystemBanner">
                FollowUp Process System
            </div>
        	<div id="StaffWorkProfileSystemContent">
            	<asp:Table runat="server" ID="StaffWorkProfileSystemContentTable">
                	<asp:TableRow></asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding-left:5px">To Enter FollowUp click on the Add button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px">To Edit FollowUp Select Respective Details and click on the Edit Button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To Delete FollowUp Select Respective Details and click on the Delete button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To View FollowUp Select Respective Details and click on the View button.</asp:TableCell>
