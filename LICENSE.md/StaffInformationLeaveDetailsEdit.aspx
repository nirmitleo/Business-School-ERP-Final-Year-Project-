<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationLeaveDetailsEdit.aspx.cs" Inherits="StaffInformationLeaveDetailsEdit" %>
    ...
    <form id="Form1" runat="server">
        ...
        <!-- ********** Start of Button ******************* -->
                <div id="Buttons" style="position:absolute;top:1200px;width:100%;outline:none;">
                    <asp:Button value="Modify Leave" runat="server" Text="Modify Leave" ID="ModifyLeave" name="ModifyLeave"  class="BlueButton" ></asp:Button>
                </div>
        <!-- *********** End of Button ******************* --> 
        </form>
