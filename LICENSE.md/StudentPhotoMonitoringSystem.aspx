<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentPhotoMonitoringSystem.aspx.cs" Inherits="StudentPhotoMonitoringSystem" %>
...
<body>
    <form id="StudentPhotoMonitoringSystemForm" runat="server">
        ...
        <div id="StudentPhotoMonitoringSystemContent">
            <div>
                <label for="StudentRegistrationNo">Student Registration No : </label>
                <asp:TextBox runat="server" ID="StudentRegistrationNo" name="StudentRegistrationNo"></asp:TextBox>
            </div>
            <div>
                <label for="StudentPhoto">Student Photo : </label>
                <asp:TextBox runat="server" ID="StudentPhoto" name="StudentPhoto"></asp:TextBox>
                <asp:Button runat="server"  ID="StudentPhotoButton" name="StudentPhotoButton" value="Browse" Text="Browse" style="width:75px"></asp:Button>
            </div>
            <div>
