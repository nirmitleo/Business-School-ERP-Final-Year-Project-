<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffWorkProfileSystem.aspx.cs" Inherits="StaffWorkProfileSystem" %>
...
<head id="Head1" runat="server">
		...
		<title>Staff Work Profile System</title>
        <style type="text/css">
        	...
        	<div id="StaffWorkProfileSystemContent">
            	<asp:Table runat="server" ID="StaffWorkProfileSystemContentTable">
                	<asp:TableRow></asp:TableRow>
                     <asp:TableRow>
                        <asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding-left:5px">To Enter Staff New Working Profile click on the Add button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px">To Edit Staff Working Profile Select Respective Details and click on the Edit Button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To Delete Staff Working Profile Select Respective Details and click on the Delete button.</asp:TableCell>
                    ...
                    <asp:TableRow>
                    	<asp:TableCell style="color:blue;font-size:12px;font-family:Calibri;padding:5px;">To View Staff Working Profile Select Respective Details and click on the View button.</asp:TableCell>
