<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StaffInformationBasicSalaryDetailsView.aspx.cs" Inherits="StaffInformationBasicSalaryDetailView" %>
...
<head id="Head1" runat="server">
    ...
    <form id="Form1" runat="server">
       ...
       <!-- ************* Start of Leave Details ***************** -->
        <div id="BasicSalaryDetails">
        	<div id="BasicSalaryDetailsBanner">
                Basic Salary Details
            </div>
            <div id="BasicSalaryDetailsContentDiv">
        		<asp:Table runat="server" ID="BasicSalaryDetailsContentTable">
       ...
       <Pre>Thanks for viewing the Salary Details!!</Pre>
       </div>
