<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentTransferMonitoringSystem.aspx.cs" Inherits="StudentTransferMonitoringSystem" %>
...
<head runat="server">
    ...
    *
            ...
            div#BlueGradient
            {
         	...
         	/*--------Styling the Student Transfer Monitoring System--------*/
            div#StudentTransferMonitoringSystem
            {
                display:block;
                position:absolute;
                width:100%;
            ...
            div#StudentTransferMonitoringSystem div#StudentTransferMonitoringSystemBanner
            {
                display:block;
                height:30px;
                line-height:30px;
            ...
            div#StudentTransferMonitoringSystem table,tr,td 
            {
            ...
            div#StudentTransferMonitoringSystem table 
            {
                position:absolute;
                width:100%;
            }
            div#StudentTransferMonitoringSystem .BlueButton
            {
                background:#018788;
                width:75px;
                height:25px;
            ...
            div#StudentTransferMonitoringSystem .BlueButton:hover
            {
                cursor:pointer;
            }
        </style>
...
<body>
    <form id="StudentTransferMonitoringSystemForm" runat="server">
        <!-- *************Kohinoor Banner****************** -->
        ...
        <!-- ************* Student Transfer Monitoring System **********-->
        <div id="StudentTransferMonitoringSystem">
        	<div id="StudentTransferMonitoringSystemBanner">
            	Tranfer Monitoring System
            </div>
            <div id="StudentTransferMonitoringSystemContent">
            	<asp:Table runat="server" ID="StudentTransferMonitoringSystemContentTable">
                	<asp:TableRow></asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell width="45%" HorizontalAlign="Center">
                        	<label for="SearchType" style="color:#264f9f;font-family:Segoe UI;font-weight:bold;font-size:14px;">Search Type : </label>
                        	<asp:DropDownList runat="server" name="SearchType">
                                <asp:ListItem Selected="True">Select</asp:ListItem>
                            	<asp:ListItem value="Something1">Something A</asp:ListItem>
                            	<asp:ListItem value="Something2">Something B</asp:ListItem>
                            	<asp:ListItem value="Something3">Something C</asp:ListItem>
                            	<asp:ListItem value="Something4">Something D</asp:ListItem>
                            	<asp:ListItem value="Something5">Something E</asp:ListItem>
                        	</asp:DropDownList>
                       	</asp:TableCell>
                        <asp:TableCell HorizontalAlign="left">
                            <label for="NameOrNo" style="color:#264f9f;font-family:Segoe UI;font-weight:bold;font-size:14px;">Name or No : </label>
                            <asp:TextBox runat="server" ID="NameOrNo" name="NameOrNo"></asp:TextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell style="color:#264f9f;font-size:12px;font-family:Segoe UI;padding-left:5px;font-size:11px;">To Search Student Details Select Respective Heads and click on the Search button.</asp:TableCell>
